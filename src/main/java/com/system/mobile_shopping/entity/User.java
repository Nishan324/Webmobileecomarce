...
public class User implements UserDetails {
    @Id
    @SequenceGenerator(name = "ms_users_seq_gen", sequenceName = "ms_users_id_seq", allocationSize = 1)
    @GeneratedValue(generator = "ms_users_seq_gen", strategy = GenerationType.SEQUENCE)
    private Integer id;
